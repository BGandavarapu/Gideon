...
Public surface
--------------
Rewriter            NVIDIA NIM (Nemotron) wrapper: rewrite bullets, generate
                    summaries, reorder skills, batch-process content.
RateLimiter         Thread-safe token-bucket limiter with daily quota tracking.
QuotaExceededError  Raised when the daily NIM quota would be exceeded.
